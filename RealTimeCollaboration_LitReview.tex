...
\section{Discussion}
Since new web standards have been implemented, namely WebSocket and WebRTC we no longer have to use subpar solutions to our problem. WebScoket and WebRTC are still new technologies but most updated web browsers support them by now.
...
\cite{grasberger2013data}
\cite{almasi2013evaluation}
\cite{solomon2012distributed}
\cite{skvorc2014performance}
\cite{panagiotakis2013architecture}
